...
@bot.message_handler(commands=["ea", "esclusivo"])
def handle_start_help(message):
	bot.reply_to(message, ea1())

@bot.message_handler(commands=["ea2", "esclusivo2"])
def handle_start_help(message):
	bot.reply_to(message, ea2())

@bot.message_handler(commands=["ea3", "esclusivo3"])
def handle_start_help(message):
	bot.reply_to(message, ea3())

@bot.message_handler(commands=["ea4", "esclusivo4"])
def handle_start_help(message):
	bot.reply_to(message, ea4())

@bot.message_handler(commands=["ea5", "esclusivo5"])
def handle_start_help(message):
	bot.reply_to(message, ea5())

@bot.message_handler(commands=["ea_us"])
def handle_start_help(message):
